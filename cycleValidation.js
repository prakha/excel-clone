// Storage for all sheets' graph components
let collectedGraphComponent = [];

// Storage -> 2D array (Basic needed)
let graphComponentMatrix = [];

// Initialize graph component matrix
function initGraphComponentMatrix() {
    let newGraphComponentMatrix = [];
    for (let i = 0; i < rows; i++) {
        ...
        newGraphComponentMatrix.push(row);
    }
    return newGraphComponentMatrix;
}

// Initialize first graph component matrix
graphComponentMatrix = initGraphComponentMatrix();
